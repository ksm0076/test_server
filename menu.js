...
const d = new Date().getDay(); // 오늘 요일 숫자 표기 (일요일 =0)
console.log(`오늘은 ${day[d]}`);

const url = 'https://sobi.chonbuk.ac.kr/menu/week_menu.php';
const selector = `#contents > div.contentsArea.WeekMenu > div:nth-child(227) > div:nth-child(2) > table > tbody > tr:nth-child(1) > td:nth-child(${d + 2}) > ul > li`;
